...
function Footer() {
  return (
    <footer className="px-12 md:mt-24 sm:px-14 w-full  md:px-20 flex flex-col items-center justify-center text-center lg:text-start  gap-10  lg:px-28 xl:px-32">
      ...
      <div className="flex flex-col md:pb-14 md:pt-8 border-t-[2px] border-[rgb(255,255,255,4%)] w-full items-center justify-center md:gap-40 md:flex-row-reverse gap-4">
        <Link
          href="/contact"
