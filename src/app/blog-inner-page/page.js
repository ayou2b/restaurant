...
function page() {
  return (
    <Fragment>
      <Header></Header>
      <section className="mt-20 mb-20 text-center flex flex-col items-center justify-center gap-8 px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32">
      ...
      <section className="h-96 w-full mb-20 px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32">
        <Image
          src={image_1}
          alt=""
      ...
      <section className="flex flex-col mb-20 gap-8 px-20 sm:px-40 md:px-44 lg:px-48 xl:px-52 text-center lg:text-start">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="leading-7">Step 2: Open the plugin on your artboard</p>
