...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-12 mt-14 sm:px-14 md:px-20 transition-all  lg:px-28 xl:px-32 mb-20 text-center flex flex-col items-center justify-center gap-10 lg:flex-row-reverse lg:text-start lg:justify-between">
      ...
      <section className="px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32 text-center lg:text-start w-full h-96">
        <div
          style={{
          ...
          className="w-full h-full relative flex items-center lg:justify-start p-12 lg:pl-20 justify-center"
        >
      ...
      <section className="mb-20 px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32 text-center w-full lg:text-start ">
        <div className="px-20 py-12  bg-[rgb(255,255,255,3%)]">
      ...
      <section className="mb-20 px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32 text-center w-full lg:text-start flex items-center justify-center flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
