...
export default function Home() {
  ...
  return (
    <Fragment>
      <header className="flex items-center justify-between py-4 h-[10vh] px-12 sm:px-14 md:px-20 lg:px-28 xl:px-32">
      ...
      <section className="px-12 sm:px-14 md:px-20 lg:px-28 xl:px-32 mb-20 mt-6 text-center flex flex-col items-center justify-center gap-10 lg:flex-row-reverse lg:text-start lg:justify-between w-full lg:h-[90vh]">
        <div>
          <Image
            src={hero_image}
            alt=""
        ...
        <div className="flex flex-col items-center transition-all justify-center lg:items-start gap-6 max-w-lg">
          ...
          <div className="flex flex-col items-center justify-center gap-2 lg:items-start">
            ...
            <div>
              ...
              <p className="leading-7">Master canteen, BBSR , Odisha 752054</p>
            </div>
            <div>
      ...
      <section className="px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32 mb-20 text-center flex flex-col items-center justify-center gap-10 lg:flex-row-reverse lg:text-start lg:justify-between">
      ...
      <section className="px-12 transition-all sm:px-14 md:px-20  lg:px-28 xl:px-32 mb-20 text-center lg:text-start">
      ...
      <section className="px-12 transition-all sm:px-14 md:px-20  lg:px-28 xl:px-32 mb-20 text-center lg:text-start flex flex-col items-center">
      ...
      <section className="mb-20 text-center px-12 lg:p-0 flex flex-col lg:flex-row-reverse lg:justify-between lg:text-start w-full">
        <div
      ...
      <section className="px-12 sm:px-14 md:px-20  lg:px-28 xl:px-32 mb-20 text-center lg:text-start">
        ...
        <div className="flex flex-col items-center transition-all justify-center gap-10 md:grid md:grid-cols-3">
          ...
          <div className="group cursor-pointer">
            ...
            <Image src={image_10} alt="" className="object-cover h-48"></Image>
          </div>
          ...
          <div className="group cursor-pointer">
            ...
            <Image src={image_11} alt="" className="object-cover h-48"></Image>
          </div>
        </div>
      </section>
      ...
      <footer className="px-12 md:mt-24 sm:px-14 w-full text-center lg:text-start  md:px-20 flex flex-col items-center justify-center  gap-10  lg:px-28 xl:px-32">
        <h3 className="font-bold text-[#FFB577] uppercase tracking-widest">
          <Link href="/">Rendezvous</Link>
        </h3>
