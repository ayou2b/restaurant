...
function page() {
  return (
    <Fragment>
      ...
      <section className="px-12 md:h-[93vh] sm:px-14 md:px-20 lg:px-28 xl:px-32 mb-20 mt-14  text-center flex flex-col gap-10  items-center justify-center ">
      ...
      <section className="px-12 sm:px-14 md:px-20 mb-20 lg:px-28 xl:px-32 text-center md:text-start flex flex-col items-center justify-center gap-10">
        <h1>All Articles</h1>
