...
function page() {
  return (
    <Fragment>
      <Header></Header>
      <section className="px-12 sm:px-14 md:px-20 lg:px-28 xl:px-32 mb-20 mt-14 text-center xl:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center justify-center gap-16 xl:flex-row xl:justify-between">
          ...
          <div className="max-w-md 2xl:max-w-xl flex flex-col gap-3">
