...
function page() {
  return (
    <Fragment>
      <Header></Header>
      <section className="mt-14 mb-20 px-12 sm:px-14 transition-all md:px-20  lg:px-28 xl:px-32 text-center  lg:text-start flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center justify-center lg:justify-between gap-12 lg:flex-row-reverse">
          ...
          <div className="flex flex-col items-center lg:items-start max-w-lg 2xl:max-w-xl gap-8">
